...
@section('title', __('sales.breadcrumb.sale_payments'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('sales.breadcrumb.sale_payments') }}</li>
    </ol>
@endsection
    ...
    <script>
     document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteModal.addEventListener('show.bs.modal', function (event) {
            ...
            var deleteUrl = "{{ route('sale-payments.destroy', ':id') }}".replace(':id', userId);
