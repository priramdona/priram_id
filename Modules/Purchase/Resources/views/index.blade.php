...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('purchase.breadcrumb.purchases') }}</li>
    </ol>
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('purchases.create') }}" class="btn btn-primary">
                            {{ __('purchase.index.add_purchase') }} <i class="bi bi-plus"></i>
                        </a>
        ...
        $(document).ready(function() {
            ...
            function showActionModal() {
             ...
             $('#modalEditBtn').on('click', function() {
                if (selectedProductId) {
                    var editUrl = "{{ route('purchases.edit', ':id') }}";
            ...
            $('#modalPaymentBtn').on('click', function() {
                if (selectedProductId) {
                    var paymentUrl = "{{ route('purchase-payments.index', ':id') }}";
            ...
            $('#modalAddPaymentBtn').on('click', function() {
                if (selectedProductId) {
                    var addPaymentUrl = "{{ route('purchase-payments.create', ':id') }}";
            ...
            $('#modalShowBtn').on('click', function() {
                if (selectedProductId) {
                    var editUrl = "{{ route('purchases.show', ':id') }}";
                    editUrl = editUrl.replace(':id', selectedProductId);
                    window.location.href = editUrl;
                } else {
