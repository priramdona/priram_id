...
@section('title', __('sales_return.payment_status'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('sales_return.payment_status') }}</li>
    </ol>
@endsection
    ...
    <script>
     document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteModal.addEventListener('show.bs.modal', function (event) {
            ...
            var deleteUrl = "{{ route('sale-return-payments.destroy', ':id') }}".replace(':id', userId);
