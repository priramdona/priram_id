...
@section('title', __('sales_return.add_payment'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('sales_return.add_payment') }}</li>
    </ol>
@endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary">{{ __('sales_return.create_payment') }} <i class="bi bi-check"></i></button>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="payment_method" id="payment_method" required>
                                            <option value="Cash">{{ __('sales_return.cash') }}</option>
                                            <option value="Credit Card">{{ __('sales_return.credit_card') }}</option>
                                            <option value="Bank Transfer">{{ __('sales_return.bank_transfer') }}</option>
                                            <option value="Cheque">{{ __('sales_return.cheque') }}</option>
                                            <option value="Other">{{ __('sales_return.other') }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
