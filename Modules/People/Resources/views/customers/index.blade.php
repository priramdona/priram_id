...
@section('title', __('people.customers'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('people.customers') }}</li>
    </ol>
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('customers.create') }}" class="btn btn-primary">
                            {{ __('people.add_customer') }} <i class="bi bi-plus"></i>
                        </a>
    ...
    <script>
     document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteModal.addEventListener('show.bs.modal', function (event) {
            ...
            var deleteUrl = "{{ route('customers.destroy', ':id') }}".replace(':id', userId);
