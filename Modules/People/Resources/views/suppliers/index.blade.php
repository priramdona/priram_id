...
@section('title', __('people.suppliers'))
...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('people.suppliers') }}</li>
    </ol>
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('suppliers.create') }}" class="btn btn-primary">
                            {{ __('people.add_supplier') }} <i class="bi bi-plus"></i>
                        </a>
    ...
    <script>
     document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteModal.addEventListener('show.bs.modal', function (event) {
            ...
            var deleteUrl = "{{ route('suppliers.destroy', ':id') }}".replace(':id', userId);
