...
@section('title', __('purchase_return.edit_purchase_return'))
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $purchase_return->status == 'Pending' ? 'selected' : '' }} value="Pending">{{ __('purchase_return.pending') }}</option>
                                            <option {{ $purchase_return->status == 'Shipped' ? 'selected' : '' }} value="Shipped">{{ __('purchase_return.shipped') }}</option>
                                            <option {{ $purchase_return->status == 'Completed' ? 'selected' : '' }} value="Completed">{{ __('purchase_return.completed') }}</option>
                                        </select>
                                    </div>
                                </div>
