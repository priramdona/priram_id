        ...
        $(document).ready(function() {
            ...
            function showActionModal() {
             ...
             $('#modalEditBtn').on('click', function() {
                if (selectedProductId) {
                    var editUrl = "{{ route('purchase-returns.edit', ':id') }}";
            ...
            $('#modalPaymentBtn').on('click', function() {
                if (selectedProductId) {
                    var paymentUrl = "{{ route('purchase-return-payments.index', ':id') }}";
            ...
            $('#modalAddPaymentBtn').on('click', function() {
                if (selectedProductId) {
                    var addPaymentUrl = "{{ route('purchase-return-payments.create', ':id') }}";
            ...
            $('#modalShowBtn').on('click', function() {
                if (selectedProductId) {
                    var editUrl = "{{ route('purchase-returns.show', ':id') }}";
                    editUrl = editUrl.replace(':id', selectedProductId);
                    window.location.href = editUrl;
                } else {
            ...
            $('#modalConfirmDeleteBtn').on('click', function() {
                if (selectedProductId) {
                    var deleteUrl = "{{ route('purchase-returns.destroy', ':id') }}";
