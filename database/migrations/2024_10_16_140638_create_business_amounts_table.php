...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('business_amounts', function (Blueprint $table) {
            ...
            $table->decimal('calculated_transaction_amount', 14)->virtualAs('(transaction_amount * status_credit)')->nullable();
            ...
            $table->decimal('calculated_difference_amount',14,4)->virtualAs('(calculated_transaction_amount - calculated_received_amount)')->nullable();
