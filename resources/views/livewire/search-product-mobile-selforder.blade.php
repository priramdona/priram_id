            ...
            <div class="form-group mb-0">
                <div class="input-group">
                    ...
                    <input
                        ...
                        type="text"
                        class="form-control"
                        placeholder="{{ __('sales.search_product.placeholder') }}"
                    >
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        Quagga.init({
                ...
                if (err) {
                    console.log("{{ __('sales.search_product.scanner.error') }}", err);
                    return;
                }
                console.log("{{ __('sales.search_product.scanner.initialized') }}");
                Quagga.start();
            });
