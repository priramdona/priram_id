<div class="input-group d-flex justify-content-left">
    ...
    wire:change="priceChange($event.target.value,'{{ $cart_item->rowId }}', '{{ $cart_item->id }}')"
    style="min-width: 40px;max-width: 90px;" type="text" class="form-control"
    value={{ ($cart_item->price) }} min="0"
