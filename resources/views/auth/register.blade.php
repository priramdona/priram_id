            ...
            <div class="card mx-4 mt-4 shadow-sm">
                <div class="card-body p-4">
                    <form method="post" action="{{ url('/register') }}" onsubmit="return validateForm()">
                        ...
                        <p class="text-muted text-center">User & Business Information</p>
                        ...
                        <!-- Mobile Phone -->
                        <div class="mb-3">
                            <label for="phone_number" class="form-label">Mobile Phone</label>
                            <div class="input-group">
                        ...
                        <div class="form-check d-flex align-items-center mb-4">
                            ...
                            <label class="form-check-label" for="terms">
                                ...
                                <a href="{{ route('terms.service') }}" target="_blank">Terms of Service</a>
                                and
